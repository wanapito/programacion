package unidad_03;
	 ...
	 */
	//se crea la clase 
	public class Actividad_3_03_clase_Racional {
		private int numerador=0;
		private int denominador=0;
//se crea el contrustor
		public  Actividad_3_03_clase_Racional(int numerador, int denominador) {
...
//creamos el metodo main 
		public static void main(String[] args) {
			...
			Actividad_3_03_clase_Racional r1 = new Actividad_3_03_clase_Racional('0','0'); // crear un objeto CRacional
			r1.asignarDatos(2, 5);

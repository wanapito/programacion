...
//creamos clase
public class Actividad_A3_05_clase_rectangulo {
	private double base ;
	private double altura;
	//creamos constructor con datos iniciados 
	public Actividad_A3_05_clase_rectangulo(double base , double altura) {
		this.altura=altura;
		this.base=base;	
	}
	//cremoas conctructor por defecto 
public Actividad_A3_05_clase_rectangulo() {
	
}
//creamos constructor que haga copia del objeto
public Actividad_A3_05_clase_rectangulo(Actividad_A3_05_clase_rectangulo rectangulo1) {
...
public static void main(String[] args) {
	...
	Actividad_A3_05_clase_rectangulo rectangulo1=new Actividad_A3_05_clase_rectangulo(2,2);
	Actividad_A3_05_clase_rectangulo rectangulo2=new Actividad_A3_05_clase_rectangulo();
	Actividad_A3_05_clase_rectangulo rectangulo3=new Actividad_A3_05_clase_rectangulo(rectangulo1);

...
public abstract class Cuenta implements Serializable{
    ...
    public Cuenta(CCC numeroCuentaCCC, String nombre, String apellidos, double saldo) {
        this.numeroCuentaCCC = numeroCuentaCCC;
        this.nombre = nombre;
        this.apellidos = apellidos;
        this.saldo = saldo;
    ...
    public String mostrarDatosCuenta(){
        return "Cuenta{" + "numeroCuentaCCC=" + numeroCuentaCCC.getCodigoCCC() + ", nombre=" + nombre + ", apellidos=" + apellidos + ", saldo=" + saldo + '}';

    }
    
    public boolean comprobarCuentasIguales(CCC cuenta1, CCC cuenta2){
        if(cuenta1.toStringCCCSinEspacios() == cuenta2.toStringCCCSinEspacios()){
            return true;
        }
        return false;
    }

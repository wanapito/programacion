...
public class CuentaAhorro extends Cuenta{
    ...
    public int getInteres() {
        return interes; //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public CuentaAhorro(CCC numeroCuentaCCC, String nombre, String apellidos, double saldo) {

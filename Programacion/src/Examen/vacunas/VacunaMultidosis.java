...
public class VacunaMultidosis extends Vacuna {
	...
	// Constructor
	public VacunaMultidosis(String nombre, String fecha,
			int semanasSegundaVacuna) {
		super(nombre, fecha);
	...
	public boolean comprobarFechaSegundaDosis() {
		...
		fechaSegundaVacunaString = format1
				.format(Fecha.sumarDias(dia, mes, year, diasParaSegundaVacuna));
	...
	public boolean comprobarFechaSegundaDos() {
		...
		Calendar fechaSegundaVacuna = Fecha.sumarDias(dia, mes, year,
				diasParaSegundaVacuna);
		...
		fechaSegundaVacunaString = diaSegundaVacuna + "/" + mesSegundaVacuna
				+ "/" + yearSegundaVacuna;

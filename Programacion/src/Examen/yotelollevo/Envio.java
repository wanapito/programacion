...
public abstract class Envio implements Serializable {
	...
	public Envio(String nr, String dr, CodigoPostal cr, String nd, String dd,
			CodigoPostal cd) {
		nEnvio = contador++;
		nombreR = nr;
		dirR = dr;
	...
	public String toString() {
		return nEnvio + "\tRemitente: " + nombreR + "\t" + dirR + "\t"
				+ cpR.getCodigoPostal() + "\tDestinatario: " + nombreD + "\t"
				+ dirD + "\t" + cpD.getCodigoPostal();
	}

...
public class Actividad_2_05_notas {
	 ...
	 * de un conjunto de 25 alumnos. La más alta puede ser un 10 y la más baja un 1. Nota: 
	 * Para hacer este ejercicio será interesante disponer de una estructura de almacenamiento
	 *  de tipo array que contenga las notas. Ver Anexo I: Introducción a los arrays.
	 */

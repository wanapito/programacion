package unidad_03;
	...
	public class Actividad_3_01_Clase_complejo{
	double real ;
	double imag;
	//se inicializan los atributos
public Actividad_3_01_Clase_complejo() {
	real=0.0;
	imag=0.0;
	
}
//creamos el constructor
public Actividad_3_01_Clase_complejo(double real ,double imag) {
	this.imag=imag;
	this.real=real;
}
//getter
...
public void sumar (Actividad_3_01_Clase_complejo b) {
	this.imag+=b.imag;
	this.real+=b.real;
...
public static void main(String[] args) {
	...
	Actividad_3_01_Clase_complejo a = new Actividad_3_01_Clase_complejo();
	Actividad_3_01_Clase_complejo b = new Actividad_3_01_Clase_complejo(2,3);
//lamamos al shetter 
    a.cambia_Real(4);
    a.cambia_Imag(7);

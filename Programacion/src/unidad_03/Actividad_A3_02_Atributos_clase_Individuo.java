package unidad_03;
	 ...
	 */
	//creamos la clase
public class Actividad_A3_02_Atributos_clase_Individuo{
	private String  DNI;
	private String nombre;
	private int f_nacimiento;
	private static int poblacion;
	//creamos el constructor y se inicialiazan valores 
	public Actividad_A3_02_Atributos_clase_Individuo(String DNI,String nombre,int f_nacimiento) {
		super();
		this.DNI=DNI;
...
//getter
	...
	public static void setPoblacion(int poblacion) {
		Actividad_A3_02_Atributos_clase_Individuo.poblacion = poblacion;
	}

//creamos metodo main 
	public static void main(String[] args) {
		// se genera individuos con los datos necesarios
		Actividad_A3_02_Atributos_clase_Individuo i1=new Actividad_A3_02_Atributos_clase_Individuo("02345219R", "José Nogales", 1978);
		Actividad_A3_02_Atributos_clase_Individuo i2=new Actividad_A3_02_Atributos_clase_Individuo("32344401R", "Ana López", 1973);
		Actividad_A3_02_Atributos_clase_Individuo i3=new Actividad_A3_02_Atributos_clase_Individuo("01345420R", "Mario Carrascosa", 1988);
		Actividad_A3_02_Atributos_clase_Individuo i4=new Actividad_A3_02_Atributos_clase_Individuo("07257219R", "Jose Luis Ramírez",1999 );

		System.out.println("Tenemos una población de: " + Actividad_A3_02_Atributos_clase_Individuo.getPoblacion() + " personas");
	}

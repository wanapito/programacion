...
public class Actividad_A3_04_clase_Circulo {
	
		private double  radio;
		private double area;
		
	//creamos contructor con atributo en argumento
	public Actividad_A3_04_clase_Circulo ( double radio) {
		this.radio=radio;
	
	}
	//cremos contructor con atributo 
	public Actividad_A3_04_clase_Circulo () {
		radio=2;
...
//creamos metodo main 
	public static void main(String[] args) {
		...
		Actividad_A3_04_clase_Circulo circulo1= new Actividad_A3_04_clase_Circulo();
		Actividad_A3_04_clase_Circulo circulo2 = new Actividad_A3_04_clase_Circulo();
